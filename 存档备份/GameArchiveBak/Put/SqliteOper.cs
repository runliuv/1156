...
");
        ...
        /// <param name="DocDescr"></param>
        /// <param name="DocSource"></param>
        /// <param name="DocTarget"></param>
        /// <param name="DocTargetFull"></param>
        /// <param name="IncludeSpecDir"></param>
        /// <param name="SpecDirName"></param>
        /// <returns></returns>
        public string InsertGameDoc(string gdid, string DocDescr, string DocSource, string DocTarget, string DocTargetFull, bool IncludeSpecDir, string SpecDirName)
        {
            string rst = "1";
...
");
        ...
        /// <param name="DocTargetFull"></param>
        /// <returns></returns>
        public bool UpdateTargetPathFull(string gdid,string thatTimeMainPath, string oppoPath)
        {
            string strSql = string.Format(@"
Update GameDoc SET   
    DocTarget=@DocTarget,   
...
");
            ...
            try
            {
                ...
                slcmd.Parameters.Add(new SQLiteParameter("@DocTarget", thatTimeMainPath));
                slcmd.Parameters.Add(new SQLiteParameter("@DocTargetFull", oppoPath));                 
