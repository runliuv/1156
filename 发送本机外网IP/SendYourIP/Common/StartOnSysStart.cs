...
namespace UsualLib
{
    ...
    public class StartOnSysStart
    {
        ...
        /// <summary>
        /// isLocalMachine：TRUE为LocalMachine，FALSE为CurrentUser。
        /// </summary>
        /// <param name="startOnSysStartRegKey"></param>
        /// <param name="isLocalMachine"></param>
        public static void UnRegAutoStart(string startOnSysStartRegKey,bool isLocalMachine)
        {
            RegistryKey reg;
            if (isLocalMachine)
                reg = Registry.LocalMachine.OpenSubKey("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run", true);
